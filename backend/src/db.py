...
# class File(db.Model):   # la clase Producto hereda de db.Model
...
#     frecuencia = db.Column(db.String(10))
...
#     ResultadoComprob = db.Column(db.Float)
