...
class TechMeasurementSchema(ma.Schema):
    class Meta:
        # Fields to expose
        fields = ("id", "fecha", "hora", "area", "distancia", "azimut", "frecuenciaCaract", "unidadFC", "mic", "claseEmision", "anchoBanda", "unidad", "noEsencial1", "micNoEsencial1", "noEsencial2", "micNoEsencial2", "noEsencial3", "micNoEsencial3", "resultadoComprob")
