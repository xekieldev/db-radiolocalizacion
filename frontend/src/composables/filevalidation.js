export function useFileValidation() {
    ...
    const fileRegEx1 = /^EX-\d{4}-\d{6,10}-\s{1,3}-[A-Z]{3,7}-[A-Z]{2,10}#[A-Z]{2,8}$/
    const fileRegEx2 = /^IF-\d{4}-\d{7,9}-[A-Z]{3}-[A-Z]{2,5}#[A-Z]{6}$/
    ...
    const fileRegEx = getComposedRegex(fileRegEx1, fileRegEx2, fileRegEx3, fileRegEx4, fileRegEx5, fileRegEx6, fileRegEx7)
