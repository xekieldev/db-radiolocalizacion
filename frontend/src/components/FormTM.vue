...
<template>
  ...
  <form-kit type="form" @submit="submitHandler" submit-label="Cargar">
    <form-row>
      <form-kit type="text" label="Expediente" name="expediente"
    ...
    <form-row>
      ...
      <form-kit type="number" label="Intensidad de Campo Radioeléctrico [dBuV/m]" name="mic" help="Valor de referencia en el punto de medición"/>

    </form-row>
    <form-row>

      <form-kit type="text" label="Clase de Emisión" name="claseEmision" />
      <form-kit type="number" label="Anchura de banda" name="claseEmision" />
      <form-kit type="select" label="Unidad" name="unidad" :options="unidad" />
    </form-row>
    <form-row>
      <form-kit type="number" label="No esencial" name="noEsencial1" step="0.001"
        validation-visibility="live" />
      <form-kit type="number" label="Intensidad de Campo Radioeléctrico [dBuV/m]" name="mic" help="Valor de referencia en el punto de medición"/>
    </form-row>   
    <form-row>
      <form-kit type="number" label="No esencial" name="noEsencial2" step="0.001"
        validation-visibility="live"/>
      <form-kit type="number" label="Intensidad de Campo Radioeléctrico [dBuV/m]" name="mic" help="Valor de referencia en el punto de medición"/>
    </form-row> 
    <form-row>
      <form-kit type="number" label="No esencial" name="noEsencial3" step="0.001"
        validation-visibility="live"/>
      <form-kit type="number" label="Intensidad de Campo Radioeléctrico [dBuV/m]" name="mic" help="Valor de referencia en el punto de medición"/>
    </form-row> 

    <form-row>
      <form-kit type="textarea" label="Resultado de las Comprobaciones Técnicas" name="ResultadoComprob" />
